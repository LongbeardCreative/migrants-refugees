        ...
        <?php if(get_post_meta(get_the_ID(), "qode_hide-featured-image", true) != "yes") {
			if ( has_post_thumbnail() ) { ?>
				<div class="post_image">
					...
					<?php } else if ($_post_format == "video") {
                            $_video_type = get_post_meta(get_the_ID(), "video_format_choose", true);
                            if($_video_type == "youtube") {
                            ?>
                                <iframe id="lb_single_video" data-id="<?php the_ID(); ?>" src="https://www.youtube.com/embed/<?php echo get_post_meta(get_the_ID(), "video_format_link", true);  ?>?feature=oembed&amp;color=white&amp;disablekb=1&amp;rel=0&amp;showinfo=0" width="855" height="480" frameborder="0"></iframe>
                            <?php
                        }
                        } else {
						the_post_thumbnail('full');
					} ?>
                    <?php if ($_post_format == "video") {
                        ?>
                    </div>
                        <div class="single_video_top_part_holder">
    						<div class="single_video_top_part">
    							<div class="single_video_top_part_inner">
