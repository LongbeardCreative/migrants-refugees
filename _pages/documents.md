...
[/vc_column_text][vc_empty_space height="75px"][vc_row_inner row_type="row" type="grid" text_align="center" css_animation="" el_id="lb_documents_drive"][vc_column_inner][image_hover target="_blank" animation="yes" image="423" hover_image="422" link="https://drive.google.com/drive/folders/0B2AK2bI01BzsbU1sbmhsU3ZXNEE?usp=sharing" transition_delay="1000"][vc_empty_space height="20px"][vc_column_text]M&amp;R documents[/vc_column_text][vc_empty_space][/vc_column_inner][/vc_row_inner][vc_empty_space][vc_text_separator title="More Resources" css_animation="fadeIn" border="no" background_color="#fed766" title_color="#000000"][vc_empty_space height="75px"][vc_column_text css=".vc_custom_1493149042666{padding-right: 25px !important;padding-left: 25px !important;}"]
