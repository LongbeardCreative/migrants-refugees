...
[/vc_column_text][vc_row_inner row_type="row" type="grid" text_align="left" css_animation="" el_id="lb_documents_drive"][vc_column_inner][qode_elements_holder number_of_columns="two_columns" columns_proportion="66_33"][qode_elements_holder_item vertical_alignment="middle" advanced_animations="no"][vc_column_text]To access the repository of M&amp;R documents, click the Google Drive icon.[/vc_column_text][/qode_elements_holder_item][qode_elements_holder_item vertical_alignment="middle" advanced_animations="no"][image_hover target="_blank" animation="yes" image="423" hover_image="422" link="https://drive.google.com/drive/folders/0B2AK2bI01BzsbU1sbmhsU3ZXNEE?usp=sharing" transition_delay="1000"][/qode_elements_holder_item][/qode_elements_holder][/vc_column_inner][/vc_row_inner][vc_empty_space][vc_column_text]
